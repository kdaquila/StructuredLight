...
public class SineWaveImageMaker_16bit {
    
    Map<String,Object> config;  
    
    public SineWaveImageMaker_16bit(String configPath) {
    ...
    public static void main(String[] args) {
        ...
        // Create the app
        SineWaveImageMaker_16bit app = new SineWaveImageMaker_16bit(configAbsPath);
        
        // Create the images
        println("Creating the Images");
        Map<String,BufferedImage> sineWaveImages = app.makeImages_withLookUpFunction();
