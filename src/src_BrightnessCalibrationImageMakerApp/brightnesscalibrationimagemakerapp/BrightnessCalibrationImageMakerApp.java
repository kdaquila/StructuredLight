package brightnesscalibrationimagemakerapp;
...
public class BrightnessCalibrationImageMakerApp {
    
    Map<String,Object> config;  
    
    public BrightnessCalibrationImageMakerApp(String configPath) {
    ...
    public static void main(String[] args) {
        ...
        BrightnessCalibrationImageMakerApp app = new BrightnessCalibrationImageMakerApp(configAbsPath);
