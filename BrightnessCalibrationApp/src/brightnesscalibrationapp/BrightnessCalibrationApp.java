package brightnesscalibrationapp;

import brightnesscalibration.BrightnessCalibration;
...
public class BrightnessCalibrationApp {
    
     Map<String,Object> config;  
    
    public BrightnessCalibrationApp(String configPath) {
    ...
    public List<List<Integer>> computeLookUpTable() {
        ...
        return BrightnessCalibration.computeLookUpTable(imgStack);
    }
    ...
    public static void main(String[] args) {
        ...
        BrightnessCalibrationApp app = new BrightnessCalibrationApp(configAbsPath);
