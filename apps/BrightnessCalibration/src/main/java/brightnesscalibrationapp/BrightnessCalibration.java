...
public class BrightnessCalibration {
    ...
    public static void main(String[] args) {
        ...
        // Load images
        String brightnessCalibrationImageDir = (String) app.config.get("imageDir");   
        ...
        String brightnessCalibrationDataDir = (String) app.config.get("dataDir");
        String brightnessCalibrationDataFilename = (String) app.config.get("dataFilename");
