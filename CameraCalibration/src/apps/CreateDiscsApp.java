...
import calibrationpattern.gradientdiscs.ModelDiscs;
...
public class CreateDiscsApp {
    ...
    public static void main(String[] args) {
        ...
        int gradientRadius = (Integer) config.get("gradientRadius");
        model.drawDiscs(discRadius, gradientRadius);
